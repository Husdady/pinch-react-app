...
const styleName = string_between_strings(
  `<link href="/static`,
  `" rel="stylesheet">`,
  String(indexContent)
);
const jsName = string_between_strings(
...
<head>
  ...
  <meta name="description" content="Pinch jobs application" />
...
fs.writeFile(fileToCreate, data, function (err) {
